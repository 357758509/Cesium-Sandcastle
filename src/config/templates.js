  ...
  code: {
    ...
    CSS: {
      ...
      resources: [
        ...
        {
          name: 'cesium',
          // url: 'https://unpkg.com/cesium@1.72.0/Build/Cesium/Widgets/widgets.css'
          url: '/Cesium/Widgets/widgets.css'
        }
      ]
    },
    JS: {
      ...
      resources: [
        ...
        {
          name: 'cesium',
          // url: 'https://unpkg.com/cesium@1.72.0/Build/Cesium/Cesium.js'
      ...
      {
          "imports": {
              "vue": "/vue@3.3.4_dist_vue.esm-browser.js"
          }
      }
            `
    },
